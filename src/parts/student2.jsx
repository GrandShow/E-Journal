...
export default class StudentAllTime extends Component {
    render() {
        return (
            <div className="container-fluid">
                <div className="table-responsive mt-5" id="student2">
                        <table className="table table-bordered table-hover" style={{width: '1000px', height: '700px', fontSize: '20pt', backgroundColor: 'white', borderRadius: '10px'}}>
                            <thead>
                                <tr className="thead-dark">
                                    <th scope="col">Предмет</th>
                                    <th scope="col">10.01</th>
                                    <th scope="col">10.02</th>
